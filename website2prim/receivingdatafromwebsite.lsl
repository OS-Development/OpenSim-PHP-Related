	...
	http_request(key id, string method, string body)
    {
        ...
        if (msg0 == "FARTAPI") { // Remember the first part of the $PostData was FARTAPI? Now lets process the data.
            ...
            if (msg1 == "fart") { // The 2nd part was just fart.
            	...
            	firstname = llList2String(namelist, 0); // Christina would be the name here
            	lastname = llList2String(namelist, 1); // Vortex would be the name here
            	...
            	key resident = (key)osAvatarName2Key(firstname, lastname); // dont know why the wiki says string but we roll with that.
